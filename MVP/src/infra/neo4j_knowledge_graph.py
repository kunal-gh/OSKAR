...
SEED_TRIPLES = [
    ...
    ("Ponzi schemes", "ARE_ILLEGAL_AND_DEFINED_BY", "Using new investor money to pay earlier investors"),
    ...
    ("Pyramid schemes", "INEVITABLY_COLLAPSE_BECAUSE", "Recruitment becomes mathematically impossible"),
...
class KnowledgeGraph:
    ...
    def query_context(self, claim: str, max_hops: int = 2) -> list[dict]:
        ...
        STOP = {"this", "that", "with", "from", "they", "have", "been",
                "will", "would", "could", "there", "their", "about"}
        tokens = [
